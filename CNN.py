...
def CNN(X,y):
    ...
    conv1 = Conv1D(128, kernel_size= 512, strides=256, input_shape=(final, no_feature), name='audConv_l1')(inp1)
    ...
    conv2 = Conv1D(128, kernel_size= 512, strides=256, input_shape=(final+1, no_feature), name='audConv_21')(inp2)
